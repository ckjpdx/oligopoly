export const help = {
  policy: 'Displays the current regime policy of the nation, subsequent tax rate, and whether the nation is at war or not, which can influence industry profits.',
